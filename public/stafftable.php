...
<?php 
 ...
 $sqli = "SELECT * FROM staff ORDER BY firstname ASC";
...
?>
  ...
  <table class="table table-striped">
    ...
    ?>
      ...
      <td><?php echo "<img src='../profile pics/" . $row['profile_photo'] . "'style='width:100px; height:100px;'>"?></td> 
      <td>
      	
      	<a href="staff.php?edit=<?php echo $row['id'];  ?>" type="button" value="edit" name="edit" class="btn btn-success">Edit</a>
      	<a href="staff.php?delete=<?php echo $row['id']; ?>" class="btn btn-warning" value="delete" type="button" name="delete">Delete</a>
